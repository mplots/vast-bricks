...
test("reports every order field with the source that stated it", async ({
  ...
  expect(body.fields).toEqual([
    ...
    { name: "stored.orderDate", source: "stored" },
    { name: "stored.buyer", source: "stored" },
    { name: "stored.buyerUsername", source: "stored" },
    { name: "stored.itemCount", source: "stored" },
    { name: "stored.lotCount", source: "stored" },
    { name: "stored.paymentMethod", source: "stored" },
    { name: "stored.currency", source: "stored" },
    { name: "stored.taxType", source: "stored" },
    { name: "stored.facilitatorTax", source: "stored" },
    { name: "stored.subTotal", source: "stored" },
