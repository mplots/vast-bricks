...
/**
 * Sourcing stage: one provider fetch for the period being reconciled. A source returns the provider's data as received,
...
public interface Source<T> {
    ...
    List<T> fetch(ReconciliationPeriod period);
}
